...
parser.add_argument('--facesm', action='store_true', help='enable full FaceSM objective')
parser.add_argument('--mirror-fuse', action='store_true', help='enable mirror-fused embeddings')
parser.add_argument('--source-separation', action='store_true', help='enable source-separation term')
parser.add_argument('--source-lambda', help='source-separation weight', type=float, default=0.20)
